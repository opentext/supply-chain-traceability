...
export const CCM_WS_TYPE = "ws_inspection_reports_4ibsr";
export const CCM_WS_TYPE_ATTR_NAME = "name_lud62";
export const CCM_WS_TYPE_ATTR_BATCH = "batch_number_nhdlb";
export const CCM_WS_TYPE_ATTR_DATE = "date_caecu";
